    ...
    if (empty($nama_barang) || empty($kategori) || empty($lokasi_hilang) || empty($tanggal_hilang)) {
        ...
        if (empty($error)) {
            $stmt = safePrepare($conn, '
                ...
                (nama_barang, kategori, deskripsi, lokasi_hilang, tanggal_hilang, foto, status, created_by)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            ');
            $stmt->bind_param('sssssssi', $nama_barang, $kategori, $deskripsi, $lokasi_hilang, $tanggal_hilang, $foto, $status, $user['id']);
...
<head>
    ...
    <title>Buat Laporan Kehilangan - TemuBalik</title>
...
<body>
    ...
    <main class="main-content">
        <section class="page-header">
            <h1 class="page-title">📝 Buat Laporan Kehilangan</h1>
            <p class="page-subtitle">Laporkan barang yang Anda hilangkan dengan detail yang jelas</p>
        </section>
        ...
        <div class="form-card">
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_barang" placeholder="Masukkan nama barang yang hilang" required>
                </div>
                ...
                <div class="form-row-spacing">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="tanggal_hilang" required>
                    </div>
                </div>

                <div class="form-group">
                    <label class="form-label">Lokasi Hilang <span class="required-indicator">*</span></label>
                    <input type="text" class="form-control" name="lokasi_hilang" placeholder="Tempat terakhir kali terlihat (contoh: Stasiun Kota, Mall, dll)" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Deskripsi <span class="required-indicator">*</span></label>
                    <textarea class="form-control" name="deskripsi" rows="5" placeholder="Deskripsi detail barang: warna, merek, kondisi, ciri-ciri khusus, nomor seri, dll" required></textarea>
                </div>
                ...
                <div style="display: flex; gap: 12px;">
                    <button type="submit" class="btn-submit">
                        <i data-lucide="send" width="18"></i> Buat Laporan
                    </button>
